...
<main>
    ...
    <div class="img-wrapper">
        ...
        <div>
            <button class="next" onclick="location.href='http://localhost:8080/?id={{.Next}}'" type="button">下一个
            </button>
        </div>
        {{else}}
        <img src="http://localhost:8080/static/img/o1.jpeg" width=320px>
        <div>
            <button class="next" onclick="location.href='http://localhost:8080/?id={{.ID}}'" type="button">再试一次
            </button>
        </div>
        {{end}}
    </div>
